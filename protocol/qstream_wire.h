...
#define QSTREAM_REG_GENERATION  0x48

#define QSTREAM_REG_GENERATED_LO   0x4C
#define QSTREAM_REG_GENERATED_HI   0x50
#define QSTREAM_REG_HW_DROPS_LO    0x54
#define QSTREAM_REG_HW_DROPS_HI    0x58
...
#define QSTREAM_CONTROL_RESET (1u << 3)
